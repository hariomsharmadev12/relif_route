...
function ReviewCard({ card, index }: ReviewCardProps) {
  ...
  return (
    ...
    >
      <div
        ...
        className="glass flex h-full flex-col rounded-3xl border border-white/10 bg-white/5 p-6 text-white shadow-md transition-transform duration-200 ease-out will-change-transform"
      >
        <span className="inline-flex w-fit items-center gap-1.5 rounded-full bg-white/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-white">
        ...
        <p className="mt-2 line-clamp-6 text-pretty text-sm leading-relaxed text-white/70">
          {card.body}
        </p>
...
export function Testimonials() {
  ...
  return (
    <section className="dark relative w-full bg-black text-white py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="hidden shrink-0 gap-2 sm:flex">
            <button
              ...
              disabled={atStart}
              aria-label="Previous"
              className="flex size-10 items-center justify-center rounded-full border border-white/20 bg-white/5 text-white transition-colors hover:bg-white/10 disabled:opacity-30"
            >
        ...
        <div className="mx-auto mt-6 h-1 w-40 overflow-hidden rounded-full bg-white/20">
          <motion.div
