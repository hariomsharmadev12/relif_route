...
const MOBILE_STEPS = [
  {
    icon: Scan,
    tag: "Step 1 • AI Vision",
    tagClass: "text-emerald-500",
    iconWrapClass: "bg-emerald-500/10 text-emerald-500",
    title: "Snap & Upload Surplus",
    desc: "AI verifies meal portions, freshness, and HACCP compliance from a single photo.",
  },
  {
    icon: Truck,
    tag: "Step 2 • Smart Dispatch",
    tagClass: "text-blue-500",
    iconWrapClass: "bg-blue-500/10 text-blue-500",
    title: "Optimal Route Solver",
    desc: "PostGIS matches the nearest volunteer rider to your surplus in real-time.",
  },
  {
    icon: Building2,
    tag: "Step 3 • Zero Waste",
    tagClass: "text-emerald-500",
    iconWrapClass: "bg-emerald-500/10 text-emerald-500",
    title: "Community Handoff",
    desc: "Meals reach verified local shelters with full transparency, no waste.",
  },
];

/**
 * Static, non-scroll-jacked hero shown below the `lg` breakpoint.
 * The desktop hero relies on a sticky + overflow-hidden viewport-height
 * container, which only works when its content fits one screen. On phones
 * the columns stack, so that same content is taller than the viewport and
 * gets silently clipped. This version just flows normally down the page.
 */
function MobileHero() {
  return (
    <section className="relative w-full overflow-clip bg-background px-4 pb-16 pt-16 lg:hidden">
      {/* Ambient background (scaled down for mobile perf) */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.16),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.1),transparent_40%)]" />
      <div className="pointer-events-none absolute inset-0 ambient-grid opacity-50" />
      <div className="pointer-events-none absolute -top-24 left-1/2 size-72 -translate-x-1/2 rounded-full bg-emerald-500/10 blur-[100px]" />
      ...
      <div className="relative mx-auto flex max-w-md flex-col items-center text-center">
        <motion.span
          ...
          className="glass flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3.5 py-1.5 text-xs font-medium text-muted-foreground backdrop-blur-xl"
        >
        ...
        <motion.h1
          ...
          className="mt-6 text-balance text-4xl font-semibold leading-[1.08] tracking-tight text-foreground sm:text-5xl"
        >
          Zero Food Waste.{" "}
        ...
        <motion.p
          ...
          className="mt-4 text-pretty text-base leading-relaxed text-slate-600 dark:text-muted-foreground"
        >
        ...
        >
          <a
            href="./donor-login"
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-primary px-6 py-4 text-sm font-semibold text-primary-foreground shadow-lg shadow-primary/20 active:scale-[0.98]"
          >
          ...
          <a
            ...
            className="glass inline-flex items-center justify-center gap-2 rounded-2xl border border-emerald-100 bg-white/5 px-6 py-4 text-sm font-semibold text-foreground backdrop-blur-xl active:scale-[0.98] dark:border-border"
          >
            <MapPin className="size-4.5 text-emerald-400" aria-hidden />
        ...
        {/* Static brand character (no scroll-driven pose needed here) */}
        <motion.div
        ...
        >
          <div className="glass mb-[-20px] flex items-center gap-3 rounded-2xl border-2 border-emerald-400/80 bg-gradient-to-b from-white/90 to-emerald-50/90 px-5 py-3 shadow-[0_16px_40px_rgba(16,185,129,0.3)] backdrop-blur-2xl dark:from-slate-900/90 dark:to-emerald-950/90">
            <div className="flex size-8 items-center justify-center rounded-xl bg-emerald-500 text-white shadow-md">
              <Sparkles className="size-4" />
            </div>
            <div className="text-left">
              <span className="block font-mono text-[9px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">
                Welcome to
              </span>
          ...
          <svg
            ...
            className="size-56 drop-shadow-[0_18px_28px_rgba(0,0,0,0.22)] sm:size-64"
          >
            <defs>
              <radialGradient id="skinGradM" cx="35%" cy="30%" r="65%">
                <stop offset="0%" stopColor="#FFE3D1" />
                <stop offset="65%" stopColor="#F5B995" />
                <stop offset="100%" stopColor="#D98A62" />
              </radialGradient>
              <radialGradient id="hairGradM" cx="40%" cy="30%" r="70%">
                <stop offset="0%" stopColor="#334155" />
                <stop offset="70%" stopColor="#1E293B" />
                <stop offset="100%" stopColor="#0F172A" />
              </radialGradient>
              <linearGradient id="hoodieGradM" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#10B981" />
                <stop offset="50%" stopColor="#059669" />
                <stop offset="100%" stopColor="#047857" />
              </linearGradient>
              <radialGradient id="eyeGradM" cx="35%" cy="35%" r="60%">
            ...
            <path
              ...
              fill="url(#hoodieGradM)"
            />
            <path d="M 130 225 L 170 225 L 160 320 L 140 320 Z" fill="#F8FAFC" />
            <path d="M 150 225 L 150 320" stroke="#CBD5E1" strokeWidth="3" />
            <path
            ...
            {/* Arms folded in a namaste / welcome pose */}
            <g>
              <path
                d="M 75 220 Q 45 255, 90 268"
                stroke="url(#hoodieGradM)"
                strokeWidth="32"
                strokeLinecap="round"
              />
              <circle cx="92" cy="269" r="15" fill="url(#skinGradM)" />
            </g>
            <g>
              <path
                d="M 225 220 Q 255 255, 210 268"
                stroke="url(#hoodieGradM)"
                strokeWidth="32"
                strokeLinecap="round"
              />
              <circle cx="208" cy="269" r="15" fill="url(#skinGradM)" />
            </g>

            <g transform="rotate(6 150 150)">
              <ellipse cx="150" cy="205" rx="28" ry="12" fill="#D98A62" opacity="0.6" />
              <path d="M 132 180 L 168 180 L 164 210 L 136 210 Z" fill="url(#skinGradM)" />
              <ellipse cx="94" cy="142" rx="10" ry="14" fill="url(#skinGradM)" />
              <ellipse cx="206" cy="142" rx="10" ry="14" fill="url(#skinGradM)" />
              <ellipse cx="150" cy="140" rx="56" ry="62" fill="url(#skinGradM)" />
              <path
              ...
              <ellipse cx="128" cy="132" rx="10" ry="12" fill="#FFFFFF" />
              <ellipse cx="132" cy="132" rx="6" ry="8" fill="url(#eyeGradM)" />
              <circle cx="126" cy="129" r="2.5" fill="#FFFFFF" />
              <ellipse cx="172" cy="132" rx="10" ry="12" fill="#FFFFFF" />
              <ellipse cx="176" cy="132" rx="6" ry="8" fill="url(#eyeGradM)" />
              <circle cx="170" cy="129" r="2.5" fill="#FFFFFF" />

              <path d="M 150 132 L 146 148 Q 150 152, 154 148 Z" fill="#E29D7A" />
              <circle cx="150" cy="148" r="3" fill="#FAD1B8" />
              <circle cx="112" cy="148" r="8" fill="#F43F5E" opacity="0.18" />
              <circle cx="188" cy="148" r="8" fill="#F43F5E" opacity="0.18" />

              <path
                d="M 134 163 Q 150 167, 166 163"
                stroke="#9A4323"
                strokeWidth="3.5"
                strokeLinecap="round"
                fill="none"
        ...
        {/* Compact "how it works" list — flows normally, no absolute stacking */}
        <div className="mt-6 grid w-full gap-3">
          {MOBILE_STEPS.map((step, i) => (
            <motion.div
              ...
              className="glass flex items-start gap-3 rounded-2xl border border-white/10 bg-background/80 p-4 text-left backdrop-blur-xl"
            >
              <div
                className={`flex size-10 shrink-0 items-center justify-center rounded-xl ${step.iconWrapClass}`}
              >
                <step.icon className="size-5" />
              </div>
              <div>
                <span
                  className={`text-[10px] font-bold uppercase tracking-wider ${step.tagClass}`}
                >
                  {step.tag}
                </span>
...
export function HeroSection() {
  ...
  return (
    <div id="top" className="relative">
      {/* Mobile & tablet (< lg): simple, non-scroll-jacked hero so nothing
          gets clipped by the desktop version's h-screen/overflow-hidden pin. */}
      <MobileHero />

      {/* Desktop (lg+): original scroll-driven presenter animation */}
      <section
        ref={containerRef}
        className="relative hidden h-[320vh] w-full overflow-clip bg-background lg:block"
      >
        <div className="sticky top-0 flex h-screen w-full items-center justify-center overflow-hidden">
          ...
          <div className="relative mx-auto grid w-full max-w-7xl grid-cols-[1.02fr_1fr] items-center gap-16 px-6">
            ...
            >
              ...
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.7, delay: 0.1 }}
                className="max-w-3xl text-balance text-6xl font-semibold leading-[1.02] tracking-tight text-foreground xl:text-7xl"
              >
                Zero Food Waste.{" "}
                <span className="text-gradient-emerald">Instant Rescue.</span>
              </motion.h1>
              ...
              <motion.p
                ...
                className="max-w-xl text-pretty text-xl leading-relaxed text-slate-600 dark:text-muted-foreground"
              >
                Instantly match fresh surplus meals from kitchens and events to
                nearby shelters, volunteers, and communities before food goes to
                waste.
            ...
            <div className="relative flex h-[580px] w-full items-center justify-center perspective-[1200px]">
              ...
              */}
              <div className="absolute -right-12 top-1/2 z-30 grid -translate-y-1/2 items-center justify-center xl:-right-20">
                {/* Step 1: AI Camera Scan */}
                <motion.div
                  style={{ opacity: card1Opacity, y: card1Y, scale: card1Scale }}
                  className="col-start-1 row-start-1 glass w-72 rounded-3xl border-2 border-emerald-400/50 bg-background/85 p-5 shadow-[0_20px_60px_rgba(16,185,129,0.2)] backdrop-blur-2xl xl:w-80"
                >
                ...
                <motion.div
                  ...
                  className="col-start-1 row-start-1 glass w-72 rounded-3xl border-2 border-blue-500/50 bg-background/85 p-5 shadow-[0_20px_60px_rgba(59,130,246,0.2)] backdrop-blur-2xl xl:w-80"
                >
                  <div className="flex items-center gap-3 border-b border-white/10 pb-3">
                ...
                <motion.div
                  ...
                  className="col-start-1 row-start-1 glass w-72 rounded-3xl border-2 border-emerald-400/50 bg-background/85 p-5 shadow-[0_20px_60px_rgba(16,185,129,0.25)] backdrop-blur-2xl xl:w-80"
                >
                  <div className="flex items-center gap-3 border-b border-white/10 pb-3">
                    <div className="flex size-10 items-center justify-center rounded-2xl bg-emerald-500/10 text-emerald-500">
                ...
                <motion.div
                  ...
                  className="col-start-1 row-start-1 glass w-72 rounded-3xl border-2 border-emerald-400/80 bg-gradient-to-b from-background/90 to-emerald-950/20 p-6 shadow-[0_25px_70px_rgba(16,185,129,0.3)] backdrop-blur-2xl xl:w-80"
                >
                  <div className="flex items-center gap-3 border-b border-white/10 pb-3">
